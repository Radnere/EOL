...
public class VoskDialogText : MonoBehaviour 
{
	...
	Regex bookAppear_regex = new Regex("книга появись|появись книга|книга утеряных знаний|книга утеряных знаний появись");
    ...
    private void OnTranscriptionResult(string obj)
    {
        ...
        foreach (RecognizedPhrase p in result.Phrases)
        {
			...
			{
				SceneContoller.Instance.SpawnEchoBook(); // Предполагая, что SceneController использует паттерн Singleton
				return;
			}
